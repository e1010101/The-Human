...
public class GarbageCollectorPower extends AbstractPower
    implements CloneablePowerInterface {
    public static final String POWER_ID =
        HumanMod.makeID("GarbageCollectorPower");
    ...
    private static final Texture tex84 =
        TextureLoader.getTexture(makePowerPath("GarbageCollectorPower_84.png"));
    private static final Texture tex32 =
        TextureLoader.getTexture(makePowerPath("GarbageCollectorPower_32.png"));
    public AbstractCreature source;

    public GarbageCollectorPower(final AbstractCreature owner,
