...
public class ArsenalPower extends AbstractPower
    ...
    private static final Texture tex84 =
        TextureLoader.getTexture(makePowerPath("ArsenalPower_84.png"));
    private static final Texture tex32 =
        TextureLoader.getTexture(makePowerPath("ArsenalPower_32.png"));
    public AbstractCreature source;

    public ArsenalPower(final AbstractCreature owner,
