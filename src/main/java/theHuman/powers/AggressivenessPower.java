...
public class AggressivenessPower extends AbstractPower
    implements CloneablePowerInterface {
    public static final String POWER_ID =
        HumanMod.makeID("AggressivenessPower");
    ...
    private static final Texture tex84 =
        TextureLoader.getTexture(makePowerPath("AggressivenessPower_84.png"));
    private static final Texture tex32 =
        TextureLoader.getTexture(makePowerPath("AggressivenessPower_32.png"));
    public AbstractCreature source;

    public AggressivenessPower(final AbstractCreature owner,
