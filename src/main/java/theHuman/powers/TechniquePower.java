...
public class TechniquePower extends AbstractPower
    ...
    private static final Texture tex84 =
        TextureLoader.getTexture(makePowerPath("TechniquePower_84.png"));
    private static final Texture tex32 =
        TextureLoader.getTexture(makePowerPath("TechniquePower_32.png"));
    public AbstractCreature source;

    public TechniquePower(final AbstractCreature owner,
