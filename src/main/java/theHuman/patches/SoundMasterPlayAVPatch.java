...
public class SoundMasterPlayAVPatch {
	...
	public static class PlayAV {
		...
		@SpirePostfixPatch
		public static long Postfix(long res, SoundMaster __instance, String key, float pitchAdjust, float volumeMod) {
			if (map.containsKey(key)) {

				return map.get(key)
						  .play(Settings.SOUND_VOLUME * Settings.MASTER_VOLUME * volumeMod, 1.0F + pitchAdjust, 0.0F);
			}
			return 0L;
		}
	}
