...
public class LayDownArmsAction extends AbstractGameAction {
	...
	public void update() {
		if (this.duration == Settings.ACTION_DUR_FAST) {
			if (!finished) {
				Iterator<AbstractCard> handCards = AbstractDungeon.player.hand.group.iterator();
				Iterator<AbstractCard> drawCards = AbstractDungeon.player.drawPile.group.iterator();
				Iterator<AbstractCard> discardCards = AbstractDungeon.player.discardPile.group.iterator();
				Iterator<AbstractCard> exhaustCards = AbstractDungeon.player.exhaustPile.group.iterator();
