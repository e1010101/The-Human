...
public class FindGoodWeaponAction extends AbstractGameAction {
	...
	static {
		...
		allWeapons.addToTop(new AK47(0));
		allWeapons.addToTop(new DesertEagle(0));
		allWeapons.addToTop(new PocketPistol());
		allWeapons.addToTop(new AWP(0));
		allWeapons.addToTop(new Berreta92(0));
		allWeapons.addToTop(new Glock17(0));
	}
