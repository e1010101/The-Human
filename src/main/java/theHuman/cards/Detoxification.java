...
public class Detoxification extends AbstractDynamicCard {
    ...
    public static final String ID =
        HumanMod.makeID(Detoxification.class.getSimpleName());
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        for (int i = 0; i < p.drawPile.size(); ) {
            ...
            if (c.type == CardType.STATUS || c.type == CardType.CURSE) {
                ...
                c.setAngle(0, true);
                c.target_x =
                    AbstractDungeon.cardRandomRng.random(AbstractCard.IMG_WIDTH,
                                                         Settings.WIDTH -
                                                         AbstractCard.IMG_WIDTH);
                c.target_y = AbstractDungeon.cardRandomRng.random(
                    AbstractCard.IMG_HEIGHT,
                    Settings.HEIGHT - AbstractCard.IMG_HEIGHT);
