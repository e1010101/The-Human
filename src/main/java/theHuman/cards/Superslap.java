...
public class Superslap extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(Superslap.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		for (int i = 0; i < magicNumber; i++) {
			...
			tmp.purgeOnUse = true;
			AbstractDungeon.actionManager.cardQueue.add(new CardQueueItem(tmp, targetMonster, 0, false, true));
		}
	}
}
