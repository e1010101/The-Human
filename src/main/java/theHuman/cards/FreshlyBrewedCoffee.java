...
public class FreshlyBrewedCoffee extends AbstractDynamicCard implements OnShuffleSubscriber {

	public static final String ID = HumanMod.makeID(FreshlyBrewedCoffee.class.getSimpleName());
