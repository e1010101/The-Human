...
public class Hobbyist extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(Hobbyist.class.getSimpleName());
	...
	public boolean shouldGlowGold() {
		return HumanUtils.countUniqueCards(AbstractDungeon.player.hand) == AbstractDungeon.player.hand.size();
	}
