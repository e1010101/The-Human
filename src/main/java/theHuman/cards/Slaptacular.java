...
public class Slaptacular extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(Slaptacular.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		for (AbstractMonster mo : AbstractDungeon.getMonsters().monsters) {
			this.addToBot(new ApplyPowerAction(mo, mo, new InjuredPower(mo, mo, magicNumber)));
		}
