...
public class SpringCleaning extends AbstractDynamicCard implements OnShuffleSubscriber {

	public static final String ID = HumanMod.makeID(SpringCleaning.class.getSimpleName());
	...
	public void onShuffle() {
		this.addToBot(new DamageRandomEnemyAction(new DamageInfo(AbstractDungeon.player, 11, DamageInfo.DamageType.NORMAL), AbstractGameAction.AttackEffect.BLUNT_HEAVY));
	}
