...
public class KeepingFit extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(KeepingFit.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		this.addToBot(new ApplyPowerAction(p, p, new PeacefulPower(p, p, defaultSecondMagicNumber)));
