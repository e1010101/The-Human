...
public class Recycle extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(Recycle.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		for (int i = 0; i < magicNumber; i++) {
			this.addToBot(new MakeTempCardInDrawPileAction(HumanUtils.chooseRandomJunk(), 1, true, true, false, (float) Settings.WIDTH / 2.0F, (float) Settings.HEIGHT / 2.0F));
		}
