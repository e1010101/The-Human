...
public class Survivalist extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(Survivalist.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		...
		this.addToBot(new DamageAllEnemiesAction(p, damage * cnt, damageTypeForTurn, AbstractGameAction.AttackEffect.SLASH_DIAGONAL));
