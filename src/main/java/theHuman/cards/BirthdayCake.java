...
public class BirthdayCake extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(BirthdayCake.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		this.addToBot(new MakeTempCardInHandAction(new BirthdayPresent(), magicNumber));
	}
}
