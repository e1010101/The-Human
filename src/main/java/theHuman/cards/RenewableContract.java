...
public class RenewableContract extends AbstractDynamicCard {
	...
	public static final String ID = HumanMod.makeID(RenewableContract.class.getSimpleName());
	...
	public void use(AbstractPlayer p, AbstractMonster m) {
		this.addToBot(new ApplyPowerAction(p, p, new RenewableContractPower(p, p, magicNumber)));
	}
}
